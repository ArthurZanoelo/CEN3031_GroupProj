...
const CarpoolPostList = () => {
  ...
  useEffect(() => { if (!loading) fetchPosts(); }, [filters]);
  ...
  return (
    <div className="max-w-2xl mx-auto mt-8">
      <h2 className="text-2xl font-bold text-center mb-5">Available Carpool Rides</h2>
          ...
          <div className="divide-y divide-gray-300">
            {posts.map((post, idx) => (
              ...
              key={post.id}
                ...
                <button onClick={() => handleAcceptPost(post.id)} className="filter-element px-2 py-1 text-sm mt-2">Accept</button>
